...
And the ratio of [Retirees to Mentors](https://github.com/jzebker/Pewlett_Hackard_Analysis/blob/main/Queries/retirees_per_mentor.sql) (aka Potential Mentors to Potential Roles to Fill)
